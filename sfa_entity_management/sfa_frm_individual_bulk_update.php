...
<head>
    ...
    <title>Individual Bulk Update</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Individual Bulk Update</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='entityMIS'
                                onsubmit="getDataFormWithEvent('ajaxpage/get_data_ajax.php','isset_individual_bulk_update','entityMIS','#datadiv',event)">

...
<head>
	...
	<title>Admin Panel - Configuration Management - Add Regions</title>
	<!-- Bootstrap 4.0-->
			...
			<section class="content">
				...
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title float-left"> Add Regions </h3>
						<h3 class="box-title float-right"><a href="javascript:void(0)" class="btn btn-success" onclick="addpopup()"> Add New</a></h3>
					</div>
					<!-- /.box-header -->
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Add New Regions</h4>

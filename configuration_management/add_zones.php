...
<head>
	...
	<title>Admin Panel - Configuration Management - Add Zones</title>
	<!-- Bootstrap 4.0-->
...
<body class="hold-transition skin-black sidebar-mini" onload="getdata()">
			...
			<section class="content">
				...
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title float-left"> Add Zones Details</h3>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Add New Zone Details</h4>
	...
	<div class="modal fade" id="mymodal1">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Edit Zone Details</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span></button>
				</div>
				<div id="editdiv"></div>
	...
	<div class="modal fade" id="mymodal2">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">View Zone Details</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span></button>
				</div>
				<div id="viewdiv"></div>

                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='get_whatsapp_msg_report' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_get_whatsapp_msg_report','get_whatsapp_msg_report','#datadiv',event)">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="staticEmail" class="col-lg-3 col-form-label">SEND STATUS
                                    </label>
                                    <div class="col-lg-3">

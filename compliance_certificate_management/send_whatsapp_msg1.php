...
if ($fetch_data != 0) {
    foreach ($fetch_data as $data) {
        ...
        $update_whatsapp_send_msg = ['whatsapp_message' => $sendMessage, 'whatsapp_no' => $number, 'whatsapp_send_status' => $whatsapp_msg_statusCode, 'send_whatsapp_msg_type' => 'automatic', 'whatsapp_msg_send_date' => $send_date,'whatsapp_msg_send_time'=>$send_time, 'whatsapp_server_response' => $whatsapp_msg_status, 'whatsapp_server_msg_description' => $whatsapp_msg_description, 'update_by' => 'automatic', 'update_date_time' => $update_date_time];
        ...
        if ($result3 != '1') {
            $ccm_query->debug("Error in Updating the data");
        }
    }
}

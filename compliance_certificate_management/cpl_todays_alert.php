...
<head>
    ...
    <title>Admin Panel - Compliance Certificate Management - Todays Alert</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Today Alert </h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='getTodaysAlerts'
                                onsubmit="getDataForm('ajaxpage/get_todays_alert.php','isset_getTodaysAlerts','getTodaysAlerts','#datadiv',event)">

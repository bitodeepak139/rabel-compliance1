            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Compliance Verification</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='complianceVerification' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_complianceVerification','complianceVerification','#datadiv',event)">

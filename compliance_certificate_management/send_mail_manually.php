...
<body class="hold-transition skin-black sidebar-mini" onload="getdata('ajaxpage/get_data_ajax.php','isset_get_mail_msg_manually','#datadiv')">
	<div class="wrapper">
			...
			<section class="content">
				...
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title float-left">Send Mail Manually</h3>
					</div>
					<!-- /.box-header -->

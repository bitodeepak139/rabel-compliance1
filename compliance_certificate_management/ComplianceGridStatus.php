...
<head>
    ...
    <title>Admin Panel - Compliance Certificate Management - Compliance Grid Status</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Compliance Grid Status</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='getDataGridStatus' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_getDataGridStatus','getDataGridStatus','#datadiv',event)">

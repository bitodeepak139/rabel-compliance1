...
<head>
    ...
    <title>Admin Panel - Compliance Certificate Management - Renew Certificate</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Renew Certificate</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='renewCertificate'
                                onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_renew_Certificate','renewCertificate','#datadiv',event)">

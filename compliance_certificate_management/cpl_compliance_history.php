...
<head>
    ...
    <title>Admin Panel - Compliance Certificate Management - Compliance History</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Compliance History</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='ComplianceHistory' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_compliance_history','ComplianceHistory','#datadiv',event)">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-3 col-form-label">SELECT STATUS</label>
                                    <div class="col-md-3">

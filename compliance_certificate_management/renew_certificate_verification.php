...
<head>
    ...
    <title>Admin Panel - Compliance Certificate Management - Renewal Certificate Verification</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Renew Certificate Verification</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='renew_certificate_verification'
                                onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_renew_certificate_verification','renew_certificate_verification','#datadiv',event)">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Verification Details</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span></button>
				</div>
				<div id="verificationModalDiv"></div>
			</div>
			<!-- /.modal-content -->
		</div>
		<!-- /.modal-dialog -->

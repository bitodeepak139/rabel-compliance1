                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            if ($compliance_certificate == 0) {
                                $compliance_certificate = $ccm_query->fetch_data($conn, "cpl_compliance_master_hst as a  left join cpl_compliance_type as c on a.fk_cpl_compliancetype_id = c.pk_cpl_compliancetype_id left join sfa_ent_mst_entity as d on a.fk_sfa_ent_entity_id=d.pk_sfa_ent_entity_id", "a.*,c.compliance_name,d.entity_name", "a.pk_cpl_compliance_id='$_GET[c_id]' and a.verification_status='-1'");
                            }
                            ...
                            ?>
                                    <div class='col-12 col-md-6 p-0' style='border: solid 1px black;'>
                                        <embed src='../upload/certificate/<?php echo $certificate["certificate_file"] ?>' type='application/pdf' width='100%' height='100%'>
                                    </div>
                                    <div class='col-12 col-md-6 ' style='padding-top: 10px; border: black solid 1px;'>
                                        <table style='width: 100%; border-collapse: collapse; margin-bottom: 15px; color: black;' cellspacing='5' cellpadding='5'>
                                            <tbody>
                                                <tr>
                                        ...
                                        ?>
                                            <div class='form-group row'>
                                                ...
                                                <div class='col-sm-9'>
                                                    <textarea name='text_verification' rows='2' cols='20' id='verification_reamark' class='form-control' placeholder='Max length is 300'></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class='form-group row'>
                                                ...
                                                <div class='col-sm-6'>
                                                    <div id='Body_p1'>
                                                        <input type='submit' name='' value='Verify' id='verify_btn' class='btn btn-primary mb-2' onclick="AccepetRejectStatus('verify','<?php echo $_GET['c_id'] ?>')">
                                                        <input type='submit' name='ctl00$Body$Button2' value='Reject' id='reject_btn' class='btn btn-danger mb-2' onclick="AccepetRejectStatus('reject','<?php echo $_GET['c_id'] ?>')">
                                                    </div>
                                                </div>
                                            </div>
                                <?php

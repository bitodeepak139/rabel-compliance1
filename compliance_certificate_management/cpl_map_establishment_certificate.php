...
<head>
    ...
    <title>Admin Panel - Compliance Certificate Management - Map Establishment Certificate</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Map Establishment & Compliance</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='getDataEntity'>
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-lg-2 col-form-label">Select Entity Type <span
                                    ...
                                    <label for="staticEmail" class="col-lg-2 col-form-label">Select Entity <span
                                            class="req">*</span></label>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-2 mt-2 mt-lg-0">
                                        <input type="button" value="Submit" id="Body_btnsubmit"
                                            class="btn btn-primary mb-2" onClick="mapestablishmentCompliance()">
                                    </div>
                                </div>
                            </form>
                            <div class="form-group row">
                                <label for="staticEmail" class="col-lg-2 col-form-label">Establishment ID</label>
                                <label for="staticEmail" class="col-lg-3 col-form-label"><b
                                        id='establishmentID'></b></label>
                                <label for="staticEmail" class="col-lg-2 col-form-label">Establishment Name</label>
                                <label for="staticEmail" class="col-lg-2 col-form-label"><b
                                        id='establishmentName'></b></label>
                            </div>
                        </div>
                    </div>
                </div>

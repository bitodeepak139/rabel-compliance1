...
<head>
    ...
    <title>Admin Panel - Compliance Certificate Management - Update Compliance Certificate</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Update Compliance Certificate</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='updateComplianceCertificate'
                                onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_updateComplianceCertificate','updateComplianceCertificate','#datadiv',event)">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Update Compliance Certificate</h4>

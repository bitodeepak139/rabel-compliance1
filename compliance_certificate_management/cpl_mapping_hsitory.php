...
<head>
    ...
    <title>Admin Panel - Compliance Certificate Management - Compliance Mapping History</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Compliance Mapping History</h3>
                        ...
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='getDataEntity'>
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-lg-3 col-form-label">Select Compliance<span class="text-danger">*</span></label>
                                    <div class="col-lg-3">

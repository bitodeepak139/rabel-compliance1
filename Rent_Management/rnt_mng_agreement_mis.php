...
<head>
    ...
    <title>Admin Panel - Rent Management - Agreement MIS</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Agreement MIS</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='agreeMentMIS' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_agreementMIS','agreeMentMIS','#datadiv',event)">
...
?>
                                ...
                                <div class="form-group row">
                                    <label for="verificationStatus" class="col-lg-3 col-form-label">Verification</label>
                                    <div class="col-lg-3">

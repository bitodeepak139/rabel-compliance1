...
<head>
    ...
    <title>Admin Panel - Rent Management - Rent MIS</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Rent MIS</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='rentMIS' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_rentMIS','rentMIS','#datadiv',event)">

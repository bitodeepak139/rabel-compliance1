...
<head>
    ...
    <title>Admin Panel - Rent Management - Rent Verification</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Rent Verification</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='rentVerification' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_rentVerification','rentVerification','#datadiv',event)">
...
?>
                                    ...
                                    <div class="col-lg-3">
                                        <select name="staff_room_applicability" id="staff_room_applicability"
                                            class="form-control js-example-basic-single">
                                            <option value="">-Select-</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        <select name="state" id="state" onchange="DependantDropDown('state', 'city','ajaxpage/get_data_ajax.php', 'isset_dependent_state')"
                                            class="form-control js-example-basic-single">
                                            <option value="">-Select-</option>
                                            <?php
...
?>
                                ...
                                <div class="form-group row">
                                    <label for="AgreementStatus" class="col-lg-3 col-form-label">Agreement Status</label>
                                    <div class="col-lg-3">
                                        <select name="AgreementStatus" id="AgreementStatus"
                                            class="form-control js-example-basic-single">
                                            <option value="">-Select-</option>

...
<head>
    ...
    <title>Admin Panel - Rent Management - Verify Agreement Details</title>
    <!-- Bootstrap 4.0-->
...
<body class="hold-transition skin-black sidebar-mini">
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Verify Agreement Details</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='verifyAgreementDetails' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_verify_agreement_details','verifyAgreementDetails','#datadiv',event)">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="verificationStatus" class="col-lg-3 col-form-label">Verification Status</label>
                                    <div class="col-lg-3">
    ...
    <div class="modal fade" id="mymodal2">
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Verify Agreement Details</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                </div>
                <div id="viewdiv"></div>

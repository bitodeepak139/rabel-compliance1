...
<head>
    ...
    <title>Admin Panel - Rent Management - Add Rent Details</title>
    <!-- Bootstrap 4.0-->
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='getRentStatus' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_add_Rent_Details','getRentStatus','#datadiv',event)">

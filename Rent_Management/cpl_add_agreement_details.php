...
<head>
    ...
    <title>Admin Panel - Rent Management - Add Agreement Details</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Add Agreement Details</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='AddAgreementDetails' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_add_agreement_details','AddAgreementDetails','#datadiv',event)">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add Agreement Details</h4>

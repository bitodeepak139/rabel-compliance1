...
<head>
    ...
    <title>Admin Panel - Rent Management - Update Rent Details</title>
    <!-- Bootstrap 4.0-->
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title float-left">Add Rent Details</h3>
                    ...
                    <div class="box-body">
                        <div class="col-12 col-lg-12  ">
                            <form method="post" id='getDataGridStatus' onsubmit="getDataForm('ajaxpage/get_data_ajax.php','isset_add_Rent_Details','getDataGridStatus','#datadiv',event)">

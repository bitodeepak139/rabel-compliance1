...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-sm-5">
            <div class="row">
                <label for='verification_reamark' class='col-sm-4 col-form-label'>Verification Date</label>
                <div class='col-sm-8'>
                    <p class='mb-0'><?= $agreeMentData[0]['verification_date'] ?></p>
                </div>
                <label for='verification_reamark' class='col-sm-4 col-form-label'>Verification Time</label>
                <div class='col-sm-8'>
                    <p class='mb-0'><?= $agreeMentData[0]['verification_time'] ?></p>
                </div>
                <label for='verification_reamark' class='col-sm-4 col-form-label'>Verified By</label>
                <div class='col-sm-8'>
                    <p class='mb-0'><?= $agreeMentData[0]['user_name'] ?></p>
                </div>
                <label for='verification_reamark' class='col-sm-4 col-form-label'>Verified Remark</label>
                <div class='col-sm-8'>
